...
OutFileName = "Aspirin/Aspirin_ADME_uniform.mat";
ligand_dir = "Aspirin";  
InitialPopFile = "Aspirin/Aspirin_Pop_20.txt";
gold_config_file = "Aspirin/gold.conf";

%% Clear all molecule* directories
%% Make sure a test molecule directory is available - used in functions 
...
ADME_Penalty_Type="SoftLipinski";
...
max_rotatable_dihedrals_ADME=7;  global max_rotatable_dihedrals_ADME;
