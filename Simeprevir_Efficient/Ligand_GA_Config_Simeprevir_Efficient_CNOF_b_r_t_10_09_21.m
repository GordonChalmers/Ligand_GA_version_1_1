...
OutFileName = "Simeprevir_Efficient/Simeprevir_Efficient_no_ADME_CNOF_bond_ring_tuned_10_09_21.mat";
ligand_dir = "Simeprevir_Efficient";  
InitialPopFile = "Simeprevir_Efficient/Simeprevir_Pop_10.txt";
gold_config_file = "Simeprevir_Efficient/efficient_gold.conf";
...
%% no chance of P or S:
unnorm_percent_atom=[1,1,1,0,0,1];
%% normalize it
...
unnorm_mut_probability=[3,1,2,1,1,5,1,1,1,.02,.02,.02,.02]; 
